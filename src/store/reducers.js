...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case types.API_V1_JHGHJGJ_LIST:
    case types.API_V1_JHGHJGJ_LIST_SUCCEEDED:
    case types.API_V1_JHGHJGJ_LIST_FAILED:
    case types.API_V1_JHGHJGJ_CREATE:
    case types.API_V1_JHGHJGJ_CREATE_SUCCEEDED:
    case types.API_V1_JHGHJGJ_CREATE_FAILED:
    case types.API_V1_JHGHJGJ_READ:
    case types.API_V1_JHGHJGJ_READ_SUCCEEDED:
    case types.API_V1_JHGHJGJ_READ_FAILED:
    case types.API_V1_JHGHJGJ_UPDATE:
    case types.API_V1_JHGHJGJ_UPDATE_SUCCEEDED:
    case types.API_V1_JHGHJGJ_UPDATE_FAILED:
    case types.API_V1_JHGHJGJ_PARTIAL_UPDATE:
    case types.API_V1_JHGHJGJ_PARTIAL_UPDATE_SUCCEEDED:
    case types.API_V1_JHGHJGJ_PARTIAL_UPDATE_FAILED:
    case types.API_V1_JHGHJGJ_DELETE:
    case types.API_V1_JHGHJGJ_DELETE_SUCCEEDED:
    case types.API_V1_JHGHJGJ_DELETE_FAILED:
